...
function App() {
  ...
  const handleCalculate = async () => {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : 'Failed to fetch playlist data');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-dark-bg transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white dark:bg-dark-card rounded-2xl shadow-xl p-8 space-y-8
          ...
          {baseDuration > 0 && (
            <div className="mt-8 p-6 bg-gradient-to-r from-gray-50 to-white 
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="font-medium text-gray-900 dark:text-white">Duration Estimate</h3>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <DurationDisplay
                  ...
                  format={format}
                  icon={<Clock className="w-5 h-5 text-indigo-500 dark:text-indigo-400" />}
                />
                ...
                <DurationDisplay
                  ...
                  format={format}
                  icon={<ArrowRight className="w-5 h-5 text-purple-500 dark:text-purple-400" />}
